...
#   4. Hook 路径替换（PowerShell -replace 动态适配）
...
Write-Host "========================================"
Write-Host ""
Write-Host "⚠️  install.ps1 当前为占位版本。"
Write-Host "    完整安装逻辑将在 Phase C 实现。"
Write-Host "    方案详见：031-开源化方案评审调整/03-技术方案.md §1.2"
Write-Host ""
Write-Host "现阶段请参考 adapters/generic/README.md 手动安装。"
Write-Host ""
