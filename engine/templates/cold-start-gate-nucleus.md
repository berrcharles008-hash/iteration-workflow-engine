<!-- NUCLEUS-BEGIN v1.10 -->
<!-- cold-start-gate-nucleus v1.10 · SSOT: engine/gate-protocol.md · 钩子失效时的 Prompt 层兜底
     v1.10（2026-09-17）：新增 05/06/07 阶段化文档豁免（FIX-12②）—— 本职文档产出放行，业务代码/命令仍拦；
...
`requirements|feasibility` 的 `.md`）；其余一律拦（含所有 Bash 命令）。
